...
import 'package:tbo_app/view/employee/task_page/completed/completed_details.dart';

class EmployeeCompleteTaskList extends StatefulWidget {
  const EmployeeCompleteTaskList({super.key});

  @override
  State<EmployeeCompleteTaskList> createState() =>
      _EmployeeCompleteTaskListState();
}

class _EmployeeCompleteTaskListState extends State<EmployeeCompleteTaskList> {
  ...
  Widget build(BuildContext context) {
    return Consumer<TaskListController>(
      builder: (context, taskController, child) {
        final tasks = taskController.tasklist?.data ?? [];
        ...
        if (taskController.error != null) {
          return Center(child: Text('Error: ${taskController.error}'));
        }
        if (tasks.isEmpty) {
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => CompletedDetails(
                                task: task,
                              ), // replace with your details page
                            ),
                          );
                        },
                        child: Container(
