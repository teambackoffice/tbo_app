...
import 'package:tbo_app/view/employee/task_page/inprogress/inprogress_details.dart';

class InProgressTaskList extends StatefulWidget {
  const InProgressTaskList({super.key});

  @override
  State<InProgressTaskList> createState() => _InProgressTaskListState();
}

class _InProgressTaskListState extends State<InProgressTaskList> {
