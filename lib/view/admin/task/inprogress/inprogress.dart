...
import 'package:tbo_app/view/admin/task/inprogress/inprogress_detail.dart';

class AdminInProgressTaskList extends StatefulWidget {
  const AdminInProgressTaskList({super.key});

  @override
  State<AdminInProgressTaskList> createState() =>
      _AdminInProgressTaskListState();
}

class _AdminInProgressTaskListState extends State<AdminInProgressTaskList> {
  @override
  void initState() {
    super.initState();
            ...
            return InkWell(
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        AdminInprogressDetails(task: task), // Pass task data
                  ),
                );
              },
              child: Container(
