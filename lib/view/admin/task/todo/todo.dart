...
class AdminToDoTaskList extends StatefulWidget {
  const AdminToDoTaskList({super.key});

  @override
  State<AdminToDoTaskList> createState() => _AdminToDoTaskListState();
}

class _AdminToDoTaskListState extends State<AdminToDoTaskList> {
            ...
            return InkWell(
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        AdminTodoDetails(task: task), // Pass task data
                  ),
                );
              },
              child: Container(
